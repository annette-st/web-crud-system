...
#include <list>
#include <doctest.h>
#include "plugin/pipeline/csp/sha256.hh"
...
TEST_CASE("SHA-256") {
    ...
    const mess_and_hash sample_message_list[sample_size] = {
            mess_and_hash("",
...
#define PICOSHA2_CHECK_EQUAL_BYTES(a,b) REQUIRE(is_same_bytes(a,b))
#define PICOSHA2_CHECK_EQUAL(a,b) REQUIRE(a==b)
