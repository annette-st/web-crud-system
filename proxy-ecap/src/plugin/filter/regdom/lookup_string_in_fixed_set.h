...
// strings. The set of strings ENFORCE be known at compile time. It is converted to
...
// reversed DAFSA. Partial matches ENFORCE begin at a new component, i.e. host
...
// against a fixed set of strings. The set of strings ENFORCE be known at compile
